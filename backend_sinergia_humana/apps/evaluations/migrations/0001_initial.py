    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ai_provider', models.CharField(default='Institutional LLM', max_length=100)),
                ('ai_confidence', models.PositiveSmallIntegerField()),
                ('ai_summary', models.TextField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('candidate', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='evaluation', to='candidates.candidate')),
            ],
            options={
